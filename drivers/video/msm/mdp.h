...
#else
static inline int mdp_histogram_start(struct mdp_histogram_start_req *req)
{
	return 0;
}
static inline int mdp_histogram_stop(struct fb_info *info, uint32_t block)
{
	return 0;
}
static inline int mdp_histogram_ctrl(boolean en, uint32_t block)
{
	return 0;
}
...
static inline void __mdp_histogram_reset(struct mdp_hist_mgmt *mgmt)
{
	/* empty */
}
#endif
