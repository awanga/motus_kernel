...
#include "../../../arch/arm/mach-msm/board-mot.h"
...
extern void msm_fb_up(struct platform_device *pdev);
extern void msm_fb_down(struct platform_device *pdev);
...
static struct platform_driver __refdata mddi_tpo_nv_driver = {
